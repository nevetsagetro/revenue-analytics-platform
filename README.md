...
Salida esperada: CSV bajo `data/raw/`, una base en
`data/warehouse/revenue.db` y un resumen con ingresos, unidades, tickets y clientes.
...
- `portfolio`: 50.000 clientes, 500 productos y 250.000 tickets; apunta a más de
  500.000 líneas. Se activa con `--profile portfolio`.
...
La entrega actual cubre el esqueleto de las semanas 1–5 y deja criterios explícitos
para completar el Gate 1. Forecasting, churn y causalidad se implementarán sobre los
mismos contratos de datos para evitar una colección de notebooks desconectados.
